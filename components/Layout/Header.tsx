        ...
        <div className="relative flex justify-between w-full items-center bg-white px-5 py-2.5 dark:bg-black">
          ...
          >
            ...
            <button
              ...
              className={
                (!themeConfig.sidebar ? "lg:hidden" : "") +
                " collapse-icon flex flex-none rounded-full bg-white-light/40 p-2 hover:bg-white-light/90 hover:text-primary ltr:ml-2 rtl:mr-2 dark:bg-dark/40 dark:text-[#d0d2d6] dark:hover:bg-dark/60 dark:hover:text-primary "
              }
          ...
          <div className="flex flex-1 justify-end items-center space-x-1.5 ltr:ml-auto rtl:mr-auto rtl:space-x-reverse dark:text-[#d0d2d6] lg:space-x-2">
