          ...
          <PerfectScrollbar className="relative h-[calc(100vh-80px)]">
            <ul className="relative space-y-0.5 p-4 py-0 font-semibold">
              ...
              <li className="nav-item">
                <ul>
                  <li className="nav-item">
                    <Link href="/admin/lesson/list" className="group">
                      <div className="flex items-center">
                        <svg
                          className="group-hover:!text-primary"
                          width="20"
                  ...
                  <li className="nav-item">
                    <Link href="/admin/lesson/file/list" className="group">
                      <div className="flex items-center">
                        <svg
                          className="group-hover:!text-primary"
                          width="20"
                  ...
                  <li className="nav-item">
                    <Link href="/admin/lesson/quize/list" className="group">
                      <div className="flex items-center">
                        <svg
                          className="group-hover:!text-primary"
                          width="20"
              ...
              <li className="nav-item">
                <ul>
                  <li className="nav-item">
                    <Link href="/admin/teacher/list" className="group">
                      <div className="flex items-center">
                        <svg
                          className="group-hover:!text-primary"
                          width="20"
