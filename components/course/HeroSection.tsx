...
const CourseHeroSection = () => {
  return (
    <div className="bg-[url('/assets/course-hero-bg.png')] bg-center bg-no-repeat h-96 lg:h-[40rem] bg-cover  container mx-auto md:rounded-tl-3xl md:rounded-br-3xl overflow-hidden flex justify-center items-center p-20 my-10">
