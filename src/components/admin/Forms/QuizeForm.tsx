      ...
      <div className="grid gap-5 md:grid-cols-2 xl:grid-cols-4">
        <div className="">
          ...
          <label htmlFor="a1" className="flex gap-1.5 pt-2">
            <input type="checkbox" id="a1" name="a1" defaultChecked={quize?.answer?.includes(1)} />
            Correct answer
          </label>
        </div>
        <div>
          <InputField name="o2" label="Option 2" required defaultValue={quize?.o2} />
          <label htmlFor="a2" className="flex gap-1.5 pt-2">
            <input type="checkbox" id="a2" name="a2" defaultChecked={quize?.answer?.includes(2)} />
            Correct answer
          </label>
        </div>
        <div>
          <InputField name="o3" label="Option 3" required defaultValue={quize?.o3} />
          <label htmlFor="a3" className="flex gap-1.5 pt-2">
            <input type="checkbox" id="a3" name="a3" defaultChecked={quize?.answer?.includes(3)} />
            Correct answer
          </label>
        </div>
        <div>
          <InputField name="o4" label="Option 4" required defaultValue={quize?.o4} />
          <label htmlFor="a4" className="flex gap-1.5 pt-2">
            <input type="checkbox" id="a4" name="a4" defaultChecked={quize?.answer?.includes(4)} />
            Correct answer
          </label>
        </div>
      </div>
