  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-5">
      ...
      <div className="grid gap-5 md:grid-cols-2">
        ...
        />
        <InputField name="phone" label="Phone" required type="tel" defaultValue={teacher?.phone} />
      </div>
      <InputField name="address" label="Address" required defaultValue={teacher?.address} />
