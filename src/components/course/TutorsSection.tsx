    ...
    <div className="container text-white py-10">
      <div className="text-center">
        ...
        <p className="py-3 text-[16px]">
          Här kan du läsa igenom lärarnas profiler för att kunna välja det som passar ditt behov
          bäst.
        </p>
      </div>
        ...
        {tutors.map((tutor: any, i: number) => (
          ...
          >
            ...
            <div className="px-5 py-3">
              <h1 className="text-lg font-semibold pb-2 text-[#043B3B]">{tutor.fullname}</h1>
              <p className="text-[#365F5F] text-xs">{`${tutor.description.slice(0, 100)}...`}</p>
            </div>
