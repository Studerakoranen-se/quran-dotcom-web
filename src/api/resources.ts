...
export const getChapterVerses = async (
  ...
  fetcher<VersesResponse>(makeVersesUrl(id, locale, params, includeTranslationFields))
 ...
 */
export const getChapterIdBySlug = async (slug: string, locale = 'en'): Promise<false | string> => {
  try {
