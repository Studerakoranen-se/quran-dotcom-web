...
import { getTafsirsInitialState } from '~/store/defaultSettings/util'
...
export const selectTafsirs = (state: IRootState) => state.tafsirs
export const selectSelectedTafsirs = (state: IRootState) => state.tafsirs.selectedTafsirs
export const selectIsUsingDefaultTafsirs = (state: IRootState) =>
